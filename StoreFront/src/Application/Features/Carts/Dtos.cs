...
public record SiteProductDto(string Id, string Name, string? Description, SiteParentProductDto? Parent, SiteProductGroupDto? Group, string? Image, decimal Price, decimal? CompareAtPrice, int? Available, IEnumerable<YourBrand.Catalog.ProductAttributeDto> Attributes, IEnumerable<YourBrand.Catalog.ProductOptionDto> Options, bool HasVariants);
