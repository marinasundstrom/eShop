...
using YourBrand.StoreFront.Pages;

namespace YourBrand.StoreFront.Tests;
...
public class TodosPageTest
{
    ...
    public void ItemsShouldLoadOnInitializedSuccessful()
    {
        ...
        var fakeAccessTokenProvider = Substitute.For<YourBrand.StoreFront.Services.IAccessTokenProvider>();
