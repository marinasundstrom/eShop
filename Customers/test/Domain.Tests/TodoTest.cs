...
namespace YourBrand.Customers.Domain.Tests;
...
public class TodoTest
{
    ...
    {
        var todo = new Todo("Foo", "Bar", YourBrand.Customers.Domain.Enums.TodoStatus.NotStarted);
    ...
    public void UpdateTitle()
    {
        ...
        var todo = new Todo(oldTitle, "Bar", YourBrand.Customers.Domain.Enums.TodoStatus.NotStarted);
    ...
    public void UpdateDescription()
    {
        ...
        var todo = new Todo("Foo", oldDescription, YourBrand.Customers.Domain.Enums.TodoStatus.NotStarted);
    ...
    {
        // Arrange
        var oldStatus = YourBrand.Customers.Domain.Enums.TodoStatus.NotStarted;
