...
public sealed record RemoveIssueItem(string IssueId, string IssueItemId) : IRequest<Result>
{
    ...
    public sealed class Handler : IRequestHandler<RemoveIssueItem, Result>
    {
        ...
        public async Task<Result> Handle(RemoveIssueItem request, CancellationToken cancellationToken)
        {
            ...
            await issueRepository.DeleteIssueItem(request.IssueId, request.IssueItemId);
