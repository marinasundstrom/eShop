...
using ReceiptStatus = YourBrand.Payments.Contracts.ReceiptStatus;
...
public sealed class Test : ControllerBase
{
    ...
    public async Task UpdateStatus(string id, [FromBody] ReceiptStatus status, CancellationToken cancellationToken)
    {
