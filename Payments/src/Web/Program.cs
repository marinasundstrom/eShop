...
using YourBrand.Payments.Web;
using YourBrand.Payments.Web.Middleware;
using YourBrand.Payments.Web.Services;

Activity.DefaultIdFormat = ActivityIdFormat.W3C;
Activity.ForceDefaultIdFormat = true;

// Define some important constants to initialize tracing with
var serviceName = "YourBrand.Payments";
    ...
    options.AddPolicy(name: MyAllowSpecificOrigins,
                      policy =>
                      {
                        ...
                        /*
                          ...
                          policy.WithOrigins("https://quickpay.net/")
                          .AllowAnyHeader().AllowAnyMethod();

                          policy.WithOrigins("https://payment.quickpay.net/")
                          .AllowAnyHeader().AllowAnyMethod();

                          policy.WithOrigins("http://193.162.142.211/", 
                                            "https://193.162.142.211/")
                          .AllowAnyHeader().AllowAnyMethod();
