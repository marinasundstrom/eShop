...
using YourBrand.Customers.Pages;

namespace YourBrand.Customers.Tests;
...
public class TodosPageTest
{
    ...
    public void ItemsShouldLoadOnInitializedSuccessful()
    {
        ...
        var fakeAccessTokenProvider = Substitute.For<YourBrand.Customers.Services.IAccessTokenProvider>();
