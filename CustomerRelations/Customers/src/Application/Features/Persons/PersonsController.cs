using YourBrand.Customers.Application.Features;

using MediatR;

using Microsoft.AspNetCore.Mvc;
using YourBrand.Customers.Application.Features.Addresses;
using YourBrand.Customers.Application.Features.Persons.Queries;
using YourBrand.Customers.Application.Features.Persons;
using YourBrand.Customers.Application.Features.Persons.Commands;
