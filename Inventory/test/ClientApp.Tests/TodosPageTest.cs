...
using YourBrand.Inventory.Pages;

namespace YourBrand.Inventory.Tests;
...
public class TodosPageTest
{
    ...
    public void ItemsShouldLoadOnInitializedSuccessful()
    {
        ...
        var fakeAccessTokenProvider = Substitute.For<YourBrand.Inventory.Services.IAccessTokenProvider>();
