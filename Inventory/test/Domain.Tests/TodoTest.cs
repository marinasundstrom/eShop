...
namespace YourBrand.Inventory.Domain.Tests;
...
public class TodoTest
{
    ...
    {
        var todo = new Todo("Foo", "Bar", YourBrand.Inventory.Domain.Enums.TodoStatus.NotStarted);
    ...
    public void UpdateTitle()
    {
        ...
        var todo = new Todo(oldTitle, "Bar", YourBrand.Inventory.Domain.Enums.TodoStatus.NotStarted);
    ...
    public void UpdateDescription()
    {
        ...
        var todo = new Todo("Foo", oldDescription, YourBrand.Inventory.Domain.Enums.TodoStatus.NotStarted);
    ...
    {
        // Arrange
        var oldStatus = YourBrand.Inventory.Domain.Enums.TodoStatus.NotStarted;
