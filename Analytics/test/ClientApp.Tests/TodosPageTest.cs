...
using YourBrand.Analytics.Pages;

namespace YourBrand.Analytics.Tests;
...
public class TodosPageTest
{
    ...
    public void ItemsShouldLoadOnInitializedSuccessful()
    {
        ...
        var fakeAccessTokenProvider = Substitute.For<YourBrand.Analytics.Services.IAccessTokenProvider>();
