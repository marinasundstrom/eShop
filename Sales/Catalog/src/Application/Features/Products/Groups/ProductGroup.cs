...
public record class ProductGroupTreeNodeDto(long Id, string Name, string Handle, string Path, string? Description, ParentProductGroupDto? Parent, IEnumerable<ProductGroupTreeNodeDto> SubGroups, int ProductsCount);
