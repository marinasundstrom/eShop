...
partial class ProductsController : Controller
{
    ...
    public async Task<ActionResult<IEnumerable<Features.Attributes.AttributeValueDto>>> GetAvailableAttributeValues(string productId, string attributeId, Dictionary<string, string?> selectedAttributes)
    {
