...
public sealed record ImportProductsCsv(Stream Stream) : IRequest<IEnumerable<string>>
{
    public sealed class Handler : IRequestHandler<ImportProductsCsv, IEnumerable<string>>
    {
        ...
        public async Task<IEnumerable<string>> Handle(ImportProductsCsv request, CancellationToken cancellationToken)
        {
