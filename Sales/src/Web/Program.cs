...
using YourBrand.Sales.Infrastructure.Persistence;
using YourBrand.Sales.Presentation;
using YourBrand.Sales.Web;
using YourBrand.Sales.Web.Middleware;
using YourBrand.Sales.Web.Services;

Activity.DefaultIdFormat = ActivityIdFormat.W3C;
Activity.ForceDefaultIdFormat = true;

// Define some important constants to initialize tracing with
var serviceName = "YourBrand.Sales";
