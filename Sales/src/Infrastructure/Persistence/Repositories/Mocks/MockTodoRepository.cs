...
namespace YourBrand.Sales.Infrastructure.Persistence.Repositories.Mocks;
...
public sealed class MockOrderRepository : IOrderRepository
{
    ...
    public Task<Order?> FindByIdAsync(string id, CancellationToken cancellationToken = default)
    {
