...
using YourBrand.Subscriptions.Presentation;
using YourBrand.Subscriptions.Web;
using YourBrand.Subscriptions.Web.Middleware;
using YourBrand.Subscriptions.Web.Services;

Activity.DefaultIdFormat = ActivityIdFormat.W3C;
Activity.ForceDefaultIdFormat = true;

// Define some important constants to initialize tracing with
var serviceName = "YourBrand.Subscriptions";
...
foreach (ApiVersionDescription description in provider.ApiVersionDescriptions)
{
    builder.Services.AddOpenApiDocument(config =>
    {
        ...
        {
            document.Info.Title = "Subscriptions API";
