...
namespace YourBrand.Pricing.Application.ProductPriceLists.ProductPrices.Commands;

public sealed record RemoveProductPrice(string ProductPriceListId, string ProductPriceId) : IRequest<Result>
{
    ...
    public sealed class Handler : IRequestHandler<RemoveProductPrice, Result>
    {
        ...
        public async Task<Result> Handle(RemoveProductPrice request, CancellationToken cancellationToken)
        {
            ...
            //await productPriceListRepository.DeleteProductPrice(request. ProductPriceListId, request.ProductPriceId);
