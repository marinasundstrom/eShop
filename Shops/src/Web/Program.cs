...
using YourBrand.Shops.Presentation;
using YourBrand.Shops.Web;
using YourBrand.Shops.Web.Middleware;
using YourBrand.Shops.Web.Services;

Activity.DefaultIdFormat = ActivityIdFormat.W3C;
Activity.ForceDefaultIdFormat = true;

// Define some important constants to initialize tracing with
var serviceName = "YourBrand.Shops";
