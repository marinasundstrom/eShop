...
using YourBrand.Shops.Application;
using YourBrand.Shops.Application.Common;

namespace YourBrand.Shops.Presentation.Controllers;
...
public sealed partial class OrdersController : ControllerBase
{
    ...
    [HttpGet]
    [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(ItemsResult<ShopDto>))]
    [ProducesResponseType(StatusCodes.Status429TooManyRequests)]
    [ProducesDefaultResponseType]
    public async Task<ItemsResult<ShopDto>> GetOrders([FromQueryAttribute] int[]? status, string? customerId, string? ssn, string? assigneeId, int page = 1, int pageSize = 10, string? sortBy = null, SortDirection? sortDirection = null, CancellationToken cancellationToken = default)
    ...
    [ProducesDefaultResponseType]
    public async Task<ActionResult<ShopDto>> GetOrderById(string id, CancellationToken cancellationToken)
    {
    ...
    [ProducesResponseType(StatusCodes.Status404NotFound, Type = typeof(ProblemDetails))]
    [ProducesDefaultResponseType]
    public async Task<ActionResult<ShopDto>> GetOrderByNo(int orderNo, CancellationToken cancellationToken)
    {
    ...
    [HttpPost]
    [ProducesResponseType(StatusCodes.Status201Created, Type = typeof(ShopDto))]
    [ProducesDefaultResponseType]
    public async Task<ActionResult<ShopDto>> CreateOrder(CreateOrderRequest request, CancellationToken cancellationToken)
    {
    ...
    [ProducesResponseType(StatusCodes.Status201Created, Type = typeof(ShopDto))]
    [ProducesDefaultResponseType]
    public async Task<ActionResult<ShopDto>> CreateDraftOrder(CancellationToken cancellationToken)
    {
