...
namespace YourBrand.Shops.Client;

public static class ServiceExtensions
{
    public static IServiceCollection AddShopsClients(this IServiceCollection services, Action<IServiceProvider, HttpClient> configureClient, Action<IHttpClientBuilder>? builder = null)
    {
        /*
        services
