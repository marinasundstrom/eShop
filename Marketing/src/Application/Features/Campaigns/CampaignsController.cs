...
using YourBrand.Marketing.Application.Features.Campaigns.Queries;
using YourBrand.Marketing.Application.Features.Campaigns.Commands;
using YourBrand.Marketing.Application.Common.Models;

namespace YourBrand.Marketing.Application.Features.Campaigns;
