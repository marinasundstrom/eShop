...
using YourBrand.Marketing.Pages;

namespace YourBrand.Marketing.Tests;
...
public class TodosPageTest
{
    ...
    public void ItemsShouldLoadOnInitializedSuccessful()
    {
        ...
        var fakeAccessTokenProvider = Substitute.For<YourBrand.Marketing.Services.IAccessTokenProvider>();
